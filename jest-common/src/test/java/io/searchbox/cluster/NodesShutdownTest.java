...
public class NodesShutdownTest {
    ...
    public void testBuildURIWithNodeAttributeWildcard() throws Exception {
        ...
        assertEquals("/_cluster/nodes/ra*:2*/_shutdown", action.getURI());
    }
