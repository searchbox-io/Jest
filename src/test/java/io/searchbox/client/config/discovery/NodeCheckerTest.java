...
public class NodeCheckerTest {
	...
	public void setUp() throws Exception {
		...
		clientConfig.getClientFeatures().put(ClientConstants.DISCOVERY_ENABLED, true);
		clientConfig.getClientFeatures().put(ClientConstants.DISCOVERY_FREQUENCY, 1l);
		clientConfig.getClientFeatures().put(ClientConstants.DISCOVERY_FREQUENCY_TIMEUNIT, TimeUnit.SECONDS);
